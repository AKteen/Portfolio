...
const cardData = [
  ...
  {
    color: '#060010',
    description: 'MongoDB, Mongoose ODM',
  ...
  {
    color: '#060010',
    description: 'Git, GitHub, Docker (Basics), Vercel, VS Code, ThunderClient',
    label: 'Tools & DevOps',
    icon: '/git-logo.png'
  },
  {
            ...
            return (
              ...
              >
                ...
                <div className="card__icon">
                  {card.label === 'Programming Languages' ? (
                  ...
                  ) : card.label === 'Tools & DevOps' ? (
                    <div className="card__multi-logos">
                      <img src="/docker-logo.png" alt="Docker" className="card__logo" />
                      <img src="/github-logo.png" alt="GitHub" className="card__logo" />
                      <img src="/thunder-logo.png" alt="Thunder Client" className="card__logo" />
                    </div>
                  ) : (
                    <img src={card.icon} alt={card.label} className="card__logo" />
                  )}
                </div>
